define(["require", "exports", "Phaser"], function (require, exports, Phaser) {
                ...
                for (var i = 0; i < pairs.length; i++) {
                    ...
                    if ((bodyA.label == 'player' && bodyB.label == 'floor' && bodyA.position.y <= bodyB.position.y - bodyB.centerOffset.y) ||
                        ...
                        */
                        ...
                        var constraintBetweenWorldPointAndLastBall = this.matter.add.worldConstraint(lastBall, 10, 1, {
    ...
    Play.hanging = false;
    Play.onFloor = false; // ++why this has to be set to static
});
